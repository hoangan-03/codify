...
const ProductCard = ({ p }) => {
  ...
  return (
    <div className="max-w-sm relative bg-[#ffffff] rounded-lg shaodw dark:bg-gray-800 dark:border-gray-700">
      ...
      <div className="p-5">
        <div className="flex justify-between">
          <h5 className="mb-2 text-xl text-whiet dark:text-black">{p?.name}</h5>
